...
from src.common_utils.models import Point
from src.database.models import DBModel
import src.database.core as core_db
...
class LocationImpl(DBModel):
    ...
    def get_all():
        ...
        from src.models.core import Location
        locations = []
        for row in resp:
...
class NodeImpl(DBModel):
    ...
    def get_all_in_location(location):
        ...
        resp = core_db.execute_query(ROOT_DB, statement)
        nodes = {}
        from src.models.core import ReferenceBuilder
...
class NodeLinkImpl(DBModel):
    ...
    def get_multiple(node_ids):
        ...
        links = []
        for row in resp:
            from src.models.core import NodeLink
...
class ReferenceTypeImpl(DBModel):
    ...
    def get_all():
        ...
        types = []
        for row in resp:
            from src.models.core import ReferenceType
